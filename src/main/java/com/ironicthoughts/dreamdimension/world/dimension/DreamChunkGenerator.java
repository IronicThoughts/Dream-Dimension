...
public class DreamChunkGenerator extends NoiseChunkGenerator<DreamGenSettings> {
	...
	public DreamChunkGenerator(IWorld worldIn, BiomeProvider provider, DreamGenSettings settingsIn) {
