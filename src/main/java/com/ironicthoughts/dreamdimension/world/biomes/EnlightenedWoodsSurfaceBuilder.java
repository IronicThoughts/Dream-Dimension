...
public class EnlightenedWoodsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

	public EnlightenedWoodsSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
		super(function);
	}
