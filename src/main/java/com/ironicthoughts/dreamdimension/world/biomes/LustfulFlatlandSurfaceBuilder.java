...
public class LustfulFlatlandSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

	public LustfulFlatlandSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
		super(function);
	}
