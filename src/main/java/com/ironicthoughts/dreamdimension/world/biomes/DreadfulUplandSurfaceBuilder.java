...
public class DreadfulUplandSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

	public DreadfulUplandSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
		super(function);
	}
