...
public class MelancholyMeadowSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

	public MelancholyMeadowSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
		super(function);
	}
