...
public class JoyfulPlainsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

	public JoyfulPlainsSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> function) {
		super(function);
	}
